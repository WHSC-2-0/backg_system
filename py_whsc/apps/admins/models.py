...
class WhOrganization(models.Model):
    ...
    add_time = models.CharField(max_length=32, verbose_name='创建时间', blank=True, null=True)
...
class WhAdminLog(models.Model):
    ...
    add_time = models.CharField(max_length=32, verbose_name='操作时间', blank=True, null=True)
